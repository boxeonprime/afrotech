        ...
        <section class="max-width-1035 margin-top-4-em card">
            <section class="max-width-1035">
                <div>
                    ...
                    <div id="zelle-show" class="works-wrapper"><h2 class="zelle sentence-case">Please send donations to any of the listed details.</h2>
            ...
            <div id="card" class="display-hidden">
                <h2 class="sentence-case text-black">Use the secure form below to submit a donation.</h2>

                <form onsubmit="return false" id="shipping-address" class="">
                    <fieldset>
