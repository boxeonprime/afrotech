        ...
        <aside class="asides call-out mobile-scroll two-col-grid">
            <div>
                ...
                <p id="pitch-2" class="text-align-right max-width-25-em r-float">AfroTok is an
                    invite-only video streaming app for the black community that provides legal protection for original content and features an algorithm placing them first. The beta version will be released ASAP.</p>
