    ...
    <main>
        <section class="section maxw1035 card padding-1-em">
            ...
            <ol>
                ...
                <li>"Log files", and User Accounts, track actions occurring on the Site, and collect data including your IP
                    address, browser type, Internet service provider, referring/exit pages, and date/time stamps.</li>
                <li> "Web beacons", "tags", and "pixels" are electronic files used to record information about how you
                    browse the Site.</li>
            </ol>
            <p>Additionally when you make a donation or attempt to make a donation through the Site, we collect certain
                information from you, including your name, billing address, payment information (including credit card
                numbers, email address, and phone number. We refer to this information as "Donation Information". Some of
                these information about you is also collected when you join our waiting list. We call the latter "Waiting
                List Information."</p>

            <h2>Personal User Information</h2>
            <p>When we talk about "Personal Information" in this Privacy Statement, we are talking both about Device
                Information, Waiting List Information, and Donation Information.

            <p>How do we use your personal information?</p>

            <p>We use the Donation Information that we collect generally to fulfill any credit or debit card changes placed
                through the Site (including processing your payment information, and providing you with invoices and/or
                order confirmations). Additionally, we use this Donation Information to:</p>
            <ol>
                <li>Communicate with you;</li>
                <li>Screen our donations for potential risk or fraud; and</li>
            ...
            <p>We use the Device Information that we collect to help us screen for potential risk and fraud (in particular,
                ...
                about how our visitors browse and interact with the Site, and to assess the success of our marketing and
                advertising campaigns).</p>

            <p>We may use your account information that we collect generally to generate statistics for you, and provide
                personalized roadmaps. Additionally, we use this information to:</p>
            <ol>
                <li>Communicate with you;</li>
                <li>When in line with the preferences you have shared with us, provide you with information or advertising
                    relating to our products or services.</li>
            ...
            <p>We share your Personal Information with third parties (such as Google Analytics) to help us use your Personal
                Information, as described above.</p>

            <p>For example, we use Google Analytics to help us understand how our visitors use the Site -- you can read more
            ...
            <p>We also use Square for credit and debit card processing--you can read more about how Square uses your
                Personal Information here: https://squareup.com/us/en/legal/general/privacy.
            ...
            <p>Additionally, if you are a European resident we note that we are processing your information in order to
                fulfill contracts we might have with you (for example if you make an donation through the Site), or
            ...
            <p>When you place a donation or join our waiting list through the Site, we will maintain your Donation
                Information for our records unless and until you ask us to delete this information.</p>
            ...
            <p>For more information about our privacy practices, if you have questions, or if you would like to make a
                complaint, please contact us by e‑mail at hello@afrotok.com.</p>
